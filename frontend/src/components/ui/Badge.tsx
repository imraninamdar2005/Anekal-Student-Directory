...
export function Badge({ children, variant = 'default', className = '' }: BadgeProps) {
  const variantStyles = {
    ...
    purple: 'bg-indigo-50 text-indigo-700 border-indigo-200 dark:bg-indigo-950/50 dark:text-indigo-300 dark:border-indigo-800/60',
    outline: 'border-slate-300 text-slate-600 bg-transparent dark:border-slate-700 dark:text-slate-400',
  };
